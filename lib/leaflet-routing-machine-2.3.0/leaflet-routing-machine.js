	...
	L.Routing.Localization = {
		'en': {
			...
			instructions: {
				...
				'Head':
					['Ambil arah {dir}', ' pada {road}'],
				'Continue':
					['Lanjut ke arah {dir}', ' pada {road}'],
				'SlightRight':
					['Belok sedikit ke kanan', ' menuju {road}'],
				'Right':
					['Belok kanan', ' menuju {road}'],
				'SharpRight':
					['Belok kanan secara tajam', ' menuju {road}'],
				'TurnAround':
					['Balik arah'],
				'SharpLeft':
					['Belok kiri secara tajam', ' menuju {road}'],
				'Left':
					['Belok kiri', ' menuju {road}'],
				'SlightLeft':
					['Belok sedikit ke kiri', ' menuju {road}'],
				'WaypointReached':
					['Waypoint reached'],
				'Roundabout':
					['Ambil jalur {exitStr} pada bundaran ', ' menuju {road}'],
				'DestinationReached':
					['Lokasi Tujuan Tercapai'],
			},
